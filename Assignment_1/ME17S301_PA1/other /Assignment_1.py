...
if __name__ == '__main__':
	...
	#case UCB = 5
	epsilon_greedy_simulation = simulate(no_of_bandit_problem=no_of_bandit_problem,no_of_arms = no_of_arms ,no_of_plays = no_of_plays,temp=controls[3],mu=0,sigma=1)
	reward , optimal_action = epsilon_greedy_simulation.bandit_simulation('ucb1')
	reward_result.append(reward)
	optimal_action_result.append(optimal_action)
